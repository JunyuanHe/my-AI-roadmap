...
# print(context_ids)
generated_ids = model.generate(context_ids, max_new_tokens=400, eos_id=tokenizer.tokenizer.token_to_id("<eob>"), temperature=0.6, top_k=6)
